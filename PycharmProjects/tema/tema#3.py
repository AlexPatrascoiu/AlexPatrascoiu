...
# re_reversed = note_muzicale.reverse()                        #am reinversat lista inversata tot cu slice (alta metoda nu stiu)
...
# #varianta 2
# print(list1[2],list1[1],list1[3],list1[0],list2[2],list2[1],list2[0])  #am creat o ordina numerica fortata folosind indexii listelor.
# #varianta 3
# list1.extend(list2)
# print(list1)
